...
<div id="modal-no-animation" tabindex="-1" aria-modal="true" class="modal no-animation" data-close-modal>
  <div class="modal-content">
    <div class="header">
      <h3 class="h3 mt-0">Without animation</h3>
      <button type="button" class="btn-close" data-close-modal aria-label="Close"></button>
    </div>
    <div class="body">This overlay should be displayed without animation.</div>
