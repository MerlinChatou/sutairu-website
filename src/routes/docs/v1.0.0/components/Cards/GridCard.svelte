...
{#if isVisible}
  <div class="card opacity-0" id="grid" bind:this={cardEl}>
    ...
    <div class="body p-4 d-flex fd-col gap-6 ff-mono text-white text-center" bind:this={body}>
      <div class="grid-x gap-3 hatching-gray/30 b-1 b-gray/20 r-2">
      ...
      <div class="d-grid grid-cols-4 jc-center gap-3 hatching-gray/30 b-1 b-gray/20 r-2">
        <div class="align-cc min-h-12  bg-accent bg-400 dark:bg-700 r-2 p-2">01</div>
        <div class="align-cc min-h-12  bg-accent bg-400 dark:bg-700 r-2 p-2">02</div>
        <div class="align-cc min-h-12  bg-accent bg-400 dark:bg-700 r-2 p-2">03</div>
      ...
      <div class="grid-x grid-cols-3 grid-rows-3 jc-center gap-3 hatching-gray/30 b-1 b-gray/20 r-2">
        <div class="align-cc min-h-12 bg-accent bg-400 dark:bg-700 r-2 p-2">01</div>
