...
{#if isVisible}
  <div class="card" id="ui-animation" transition:fade={{ duration: 250 }} bind:this={cardEl}>
    ...
    <div class="footer text-right">
      <button class="btn bg-accent ff-mono" data-open-modal="documentation-modal" data-documentation="extras/ui-animation">&lt;code&gt;</button>
    </div>
  </div>
{/if}
