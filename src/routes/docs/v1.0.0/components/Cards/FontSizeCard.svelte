...
{#if isVisible}
<div class="card" id="font-size" transition:fade={{ duration: 250 }} bind:this={cardEl}>
  ...
  <div class="footer text-right">
    <button class="btn bg-accent ff-mono" data-open-modal="documentation-modal" data-documentation="core/font-size">&lt;code&gt;</button>
  </div>
</div>
{/if}
